...
John is an Assistant Professor at George Washington University in the Department of Engineering Management and Systems Engineering. He studies technological change with a focus on accelerating the transition to low-carbon technologies. His research centers around how consumer preferences, market dynamics, and policy affect the emergence of critical technologies, such as electric vehicles and solar energy. He also studies the critical relationship between the US and China in developing and mass producing these technologies. He applies a variety of methods, including discrete choice modeling, conjoint analysis, exploratory data analysis, and interview-based case studies. He speaks fluent Mandarin Chinese and has conducted extensive fieldwork in China. He is also an accomplished R programmer, violinist, and swing dancer. John holds a Ph.D. in Engineering and Public Policy from Carnegie Mellon University and a B.S. in Engineering Science and Mechanics (ESM) from Virginia Tech.

You can also see more about my background on my CV and Resume:
