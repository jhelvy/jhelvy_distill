...
description: |
  A how-to guide for using `r fontawesome::fa("r-project")` to design and implement choice-based conjoint surveys using [formr.org](https://formr.org/)
...
The central component of every conjoint survey is the set of randomized choice questions. To implement these in formr, you first need to define the set of choice questions you want to ask each respondent. I use the [conjointTools](https://jhelvy.github.io/conjointTools/) package (which I developed `r emo::ji('smile')`) to create these questions. The code to create the choice questions for this demo survey is in the [`make_choice_questions.R`](https://github.com/jhelvy/formr4conjoint/blob/master/survey/make_choice_questions.R) file in the repo. 
