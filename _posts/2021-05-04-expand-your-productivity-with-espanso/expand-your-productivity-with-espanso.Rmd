...
So far I have come up with a LOT of R snippets. I included them all at the end of the post, so I'll just highlight a few I find particularly useful.

First, I usually include a "setup" chunk in most of my Rmd files, but it's really hard to remember all the specific details for various settings. So I made a snippet for the entire setup chunk!
