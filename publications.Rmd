...
<div class="pub">
Szajnfarber, Z., Groover, J., Wei, Z., Broniatowski, D., Chernicoff, W., **Helveston, J.P.** (2021) "Evolvability Analysis Framework: Adding Transition Path and Stakeholder Diversity to Infrastructure Investment Decisions." _Under review_.
</div>
...
<div class="pub">
**Helveston, John P.** (_aut_, _cre_), Forsythe, Connor (_aut_), (2021). _logitr_: Random utility logit models with preference and willingness to pay space parameterizations. R package version 0.2.0.
```{r, echo=FALSE}
icon_link(
    icon = "fas fa-external-link-alt",
    text = "Open in new tab",
...
<div class="pub">
**Helveston, John P.** (_aut_, _cre_),  Shalloway, Brian (_ctb_), & Aden-Buie, Garrick (_ctb_). (2021). _xaringanBuilder_: Functions For Building Xaringan Slides To Different Outputs. R package version 0.0.7.
```{r, echo=FALSE}
icon_link(
    icon = "fas fa-external-link-alt",
    text = "Open in new tab",
...
<div class="pub">
**Helveston, John P.** (_aut_, _cre_). (2021). _conjointTools_: Tools For Designing Conjoint Survey Experiments. R package version 0.0.2.
```{r, echo=FALSE}
icon_link(
    icon = "fas fa-external-link-alt",
    text = "Open in new tab",
...
<div class="pub">
Cowgill, Matt (_aut_, _cre_) and **Helveston, John P.** (_ctb_). (2020). _ggannotate_: Interactively annotate ggplot2 plots. R package version 0.0.1.
```{r, echo=FALSE}
icon_link(
    icon = "fas fa-external-link-alt",
    text = "Open in new tab",
