...
<div class="pub">
**Helveston, J.P.** (2021) "Multinomial Logit Models with Willingness to Pay Space Utility Specifications in R: The {logitr} Package." _Under review_.
</div>
...
<div class="pub">
Helveston, John P, Lujin Zhao, Saurav Pantha. "Are we there yet? The significance of arrival time uncertainty in multi-modal trip choices." _Working paper_.
</div>
...
<div class="pub">
**Helveston, John P.** (_aut_, _cre_, _cph_) (2021). _logitr_: Random utility logit models with preference and willingness to pay space parameterizations. R package version 0.3.0.
```{r, echo=FALSE}
icon_link(
    icon = "fas fa-external-link-alt",
    text = "Open in new tab",
