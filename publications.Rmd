...
<div class="pub">
**Helveston, John P.** (_aut_, _cre_, _cph_) (2021). _logitr_: Random utility logit models with preference and willingness to pay space parameterizations. R package version 0.2.2.
```{r, echo=FALSE}
icon_link(
    icon = "fas fa-external-link-alt",
    text = "Open in new tab",
...
<div class="pub">
**Helveston, John P.** (_aut_, _cre_, _cph_) & Aden-Buie, Garrick (_aut_). (2021). _xaringanBuilder_: Functions For Building Xaringan Slides To Different Outputs. R package version 0.0.8.
```{r, echo=FALSE}
icon_link(
    icon = "fas fa-external-link-alt",
    text = "Open in new tab",
