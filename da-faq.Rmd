...
Beyond these channels, you can also significantly improve your chances of getting a position by networking with people in the DC area. For example, attend some of the [Data Science DC meetups](https://www.meetup.com/data-science-dc/). Many of the participants are data professionals in the greater DC area and may know of a company hiring. You can also network online. Linkedin sometimes works, but joining Slack communities can also be a helpful way to connect with people. The [R for Data Science](https://rfordatasci.com/) community, for example, has a very active Slack that you can join that is open to the public. While it is more focused on R, they often post general jobs that are not language-specific.
